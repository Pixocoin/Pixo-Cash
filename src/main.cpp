...
uint256 hashGenesisBlock("0xc0e3904169011c8e4557ff3af19b1337a4fd576b7936a5bc037f9133f6dc055f");
...
const string strMessageMagic = "PixoCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // PixoCoin: 1 days
static const int64 nTargetSpacing = 120; // PixoCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal pixocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PixoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfe4a9fbac629079d8ac95fdd5c286bb38570d85aa216cd004ef0a8dc2feaad93");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Trump signed presidential directive ordering actions to pressure North Korea";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1507185270; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2708997;

        if (fTestNet)
        {
            block.nTime    = 1506830149;
               block.nNonce   = 1531572;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8e36f5b6e8f76a35238cc2c0bacffd601ac7a7e00695e834831b6a56595a65b5"));
